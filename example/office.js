...
// can be found in top left corener of your user details page.

// IMPORTANT: Please don't confuse Thing Auth ID and Auth Token with User Auth ID and Token.
// Difference is User can WRITE to commands channel as opposite to Thing,
// which can only READ commands and WRITE to data channel.
...
// Subscribing to data channel on connect, to be informed about new deliveries as well as coffee machine status.
function onConnect() {
